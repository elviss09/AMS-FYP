...
<body>
    <div class="container">
        <div class="sidebar-box">
            @include('staff.sidebar') {{-- you can create resources/views/nurse/sidebar.blade.php --}}
        </div> 
        ...
        <div class="content">
                ...
                <section class="appointments">
                    ...
                    @if ($upcomingAppointments->count())
                        @foreach ($upcomingAppointments as $row)
                            <a href="{{ route('nurse-appointment.show', ['id' => $row->appointment_id]) }}" class="appointment-link">
            ...
            <div class="right-content">
                <section class="calendar-box">
                    @include('staff.staff-calendar') {{-- create resources/views/nurse/calendar.blade.php --}}
                </section>
                ...
                <section class="notifications">
                    ...
                    @if ($notifications->count() > 0)
                        @foreach ($notifications as $noti)
                            <a href="{{ route('staff.notification', ['id' => $noti->id]) }}" style="text-decoration:none; color:inherit;">
                                <div class="noti-box">
                                    <div class="noti-icon">
