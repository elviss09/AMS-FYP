...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/nurse-register-patient.css') }}">
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="profile-container">
                <form id="profileForm" method="POST" action="{{ route('nurse.register-patient.store') }}">
                    @csrf
                        ...
                        <div class="pd-first-row">
                            ...
                            <div class="mykad-number">
                                ...
                                <div class="details-info">
                                    <input type="text" name="mykad" maxlength="12" value="{{ old('mykad') }}" required>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="section-medical-info">
                        <div class="mi-first-row">
                            <div class="height">
                                ...
                                <div class="details-info"><input type="number" name="height" step="0.01" min="0" value="{{ old('height') }}" required> m</div>
                            </div>
                            <div class="weight">
                                <div class="details-title">Weight <span class="required">*</span></div>
                                <div class="details-info"><input type="number" name="weight" step="0.01" min="0" value="{{ old('weight') }}" required> kg</div>
                            </div>
                            <div class="bmi">
                                <div class="details-title">BMI</div>
                                <div class="details-info" id="bmi"><input type="text" name="bmi" value="{{ old('bmi') }}" readonly required></div>
                            </div>
                        </div>
                        <div class="blood-type">
                            ...
                            <div class="details-info">
                                <select name="blood" required>
                                    <option value="" disabled {{ old('blood') ? '' : 'selected' }}>Select blood type</option>
                        ...
                        <div class="mi-third-row">
                            <div class="penicillin">
                                ...
                                <div class="details-info">
                                    <label><input type="radio" name="penicillin" value="Yes" {{ old('penicillin') == 'Yes' ? 'checked' : '' }} onclick="toggleReaction(true)" required> Yes</label>
                                    <label><input type="radio" name="penicillin" value="No" {{ old('penicillin') == 'No' ? 'checked' : '' }} onclick="toggleReaction(false)"> No</label>
                                </div>
                            </div>
                            <div class="penicillin-yes" id="reactionInput">
                                <div class="details-title">If yes, what reaction?</div>
                                <div class="details-info">
                                    <textarea name="reaction" id="reactionText" rows="3" placeholder="Describe the reaction..." {{ old('penicillin') != 'Yes' ? 'readonly' : '' }}>{{ old('reaction') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
