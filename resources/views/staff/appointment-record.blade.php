...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="tab-page">
            <div class="tab-list">
                <a href="{{ route('staff.appointment-record') }}" class="{{ request()->routeIs('staff.appointment-record') ? 'active' : '' }}">All</a>
                <a href="{{ route('staff.upcoming-appointment-record') }}" class="{{ request()->routeIs('staff.upcoming-appointment') ? 'active' : '' }}">Upcoming</a>
                <a href="{{  route('staff.past-appointment-record') }}" class="{{ request()->routeIs('staff.past-appointment') ? 'active' : '' }}">Past</a>
