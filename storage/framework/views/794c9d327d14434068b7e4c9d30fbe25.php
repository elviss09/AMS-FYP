                ...
                <section class="stats">
                    <div class="stat-box">
                        ...
                        <div class="stat-content">
                            <h3><?php echo e($approvedToday); ?></h3>
                        </div>
                ...
                <section class="appointments">
                    ...
                    <?php if($upcomingAppointments->count()): ?>
                        <?php $__currentLoopData = $upcomingAppointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('nurse-appointment.show', ['id' => $row->appointment_id])); ?>" class="appointment-link">
                ...
                <section class="notifications">
                    ...
                    <?php if($notifications->count() > 0): ?>
                        <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $noti): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('staff.notification', ['id' => $noti->id])); ?>" style="text-decoration:none; color:inherit;">
                                <div class="noti-box">
                                    <div class="noti-icon">
...
<?php /**PATH C:\xampp\htdocs\amslaravel\resources\views/nurse/dashboard.blade.php ENDPATH**/ ?>