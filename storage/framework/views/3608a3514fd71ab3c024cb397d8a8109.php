...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="tab-page">
            <div class="tab-list">
                <a href="<?php echo e(route('staff.appointment-record')); ?>" class="<?php echo e(request()->routeIs('staff.appointment-record') ? 'active' : ''); ?>">All</a>
                <a href="<?php echo e(route('staff.upcoming-appointment-record')); ?>" class="<?php echo e(request()->routeIs('staff.upcoming-appointment') ? 'active' : ''); ?>">Upcoming</a>
                <a href="<?php echo e(route('staff.past-appointment-record')); ?>" class="<?php echo e(request()->routeIs('staff.past-appointment') ? 'active' : ''); ?>">Past</a>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr onclick="window.location.href='<?php echo e(url('appointment-details/'.$row->appointment_id)); ?>'">
                                ...
                                <td><span class="status <?php echo e(strtolower(str_replace(' ', '-', $row->status))); ?>"><?php echo e($row->status); ?></span></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="5" style="text-align:center;">No appointments assigned.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
...
<?php /**PATH C:\xampp\htdocs\amslaravel\resources\views/staff/appointment-record.blade.php ENDPATH**/ ?>