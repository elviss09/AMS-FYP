...
<div class="calendar-container">
    <div class="calendar-header">
        <button id="prevMonth"><img src="<?php echo e(asset('img/arrow-icon.svg')); ?>" alt="icon"></button>
        <h2 id="monthYear"></h2>
        <button id="nextMonth"><img src="<?php echo e(asset('img/arrow-icon.svg')); ?>" alt="icon"></button>
    </div>
...
<?php /**PATH C:\xampp\htdocs\amslaravel\resources\views/patient/calendar.blade.php ENDPATH**/ ?>