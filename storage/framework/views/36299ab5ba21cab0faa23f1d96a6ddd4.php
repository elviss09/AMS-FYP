...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/patient-profile.css')); ?>">
...
<body>
            ...
            <div class="profile-container">
                ...
                <div class="section-personal-details">
                    ...
                    <div class="mykad-number">
                        ...
                        <div class="details-info"><?php echo e($patient->patient_id); ?></div>
                    </div>
                    <div class="dob">
                        <div class="details-title">Date of Birth</div>
                        <div class="details-info"><?php echo e(\Carbon\Carbon::parse($patient->date_of_birth)->format('d F Y')); ?></div>
                    </div>
                    <div class="age">
                        <div class="details-title">Age</div>
                        <div class="details-info"><?php echo e(\Carbon\Carbon::parse($patient->date_of_birth)->age); ?> years old</div>
                    </div>
                    <div class="gender">
                ...
                <form id="profileForm" method="POST" action="<?php echo e(route('patient.profile.update')); ?>">
                    ...
                    <div class="section-contact-info">
                        <div class="phone-no">
                            ...
                            <div class="details-info"><input type="tel" name="phone_no" value="<?php echo e($patient->phone_no); ?>" pattern="[0-9]{7,12}" inputmode="numeric"></div>
                        </div>
                        <div class="email">
                            <div class="details-title">Email</div>
                            <div class="details-info"><input type="email" name="email" value="<?php echo e($patient->email); ?>"></div>
                        </div>
                        <div class="emergency-contact">
                            <div class="details-title">Emergency Contact</div>
                            <div class="details-info"><input type="tel" name="emergency_contact" value="<?php echo e($patient->emergency_contact); ?>" pattern="[0-9]{7,12}" inputmode="numeric"></div>
                        </div>
                        <div class="emergency-contact-relationship">
                            <div class="details-title">Emergency Contact Relationship</div>
                            <div class="details-info"><input type="text" name="emergency_relationship" value="<?php echo e($patient->emergency_relationship); ?>"></div>
                        </div>
                    </div>
                    ...
                    <div class="section-medical-info">
                        <div class="height">
                            ...
                            <div class="details-info"><?php echo e($patient->height); ?> m</div>
                        </div>
                        <div class="weight">
                            <div class="details-title">Weight</div>
                            <div class="details-info"><?php echo e($patient->weight); ?> kg</div>
                        </div>
                        <div class="bmi">
                        ...
                        <div class="blood-type">
                            ...
                            <div class="details-info"><?php echo e($patient->blood_type); ?></div>
                        </div>
                        <div class="penicillin">
                            <div class="details-title">Any reaction to Penicillin?</div>
                            <div class="details-info"><?php echo e($patient->penicillin_allergy); ?></div>
                        </div>
                        <?php if($patient->penicillin_allergy === 'Yes'): ?>
                            <div class="penicillin-yes">
                                <div class="details-title">If yes, what reaction?</div>
                                <div class="details-info"><?php echo e($patient->allergy_reaction); ?></div>
                            </div>
                        <?php endif; ?>
                    </div>
    ...
    <script>
        function calculateBMI() {
            let height = <?php echo e($patient->height); ?>;
            let weight = <?php echo e($patient->weight); ?>;
...
<?php /**PATH C:\xampp\htdocs\amslaravel\resources\views/patient/profile.blade.php ENDPATH**/ ?>