...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="tab-page">
            <div class="tab-list">
                <a href="<?php echo e(url('all-appointment-record')); ?>" class="active">All</a>
                <a href="<?php echo e(url('upcoming-appointment-record')); ?>">Upcoming</a>
                <a href="<?php echo e(url('past-appointment-record')); ?>">Past</a>
...
<?php /**PATH C:\xampp\htdocs\amslaravel\resources\views/patient/all-appointment-record.blade.php ENDPATH**/ ?>