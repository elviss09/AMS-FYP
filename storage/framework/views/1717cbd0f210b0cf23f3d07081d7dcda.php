...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/request-appointment.css')); ?>">
...
<div class="container">
    ...
    <div class="content">
        ...
        <form id="appointment-form" method="POST" action="<?php echo e(route('patient.appointment.store')); ?>" enctype="multipart/form-data" class="appointment-form">
            <?php echo csrf_field(); ?>
            ...
            <div class="select-date-time">
                <div class="req-appointment-calendar">
                    <?php echo $__env->make('patient.request-appointment-calendar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            ...
            <div id="limitModal" class="popup-box limit" style="display: none;">
                <div class="popup-content limit">
                    <div class="alert-icon"><img src="<?php echo e(asset('img/alert.png')); ?>" alt="icon"></div>
...
<?php if(session('appointment_limit')): ?>
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            fetch("<?php echo e(route('clear.appointment.limit')); ?>", {
                method: "POST",
                headers: {
...
<?php /**PATH C:\xampp\htdocs\amslaravel\resources\views/patient/request-appointment.blade.php ENDPATH**/ ?>