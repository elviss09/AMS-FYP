...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="tab-page">
            <div class="tab-list">
                <a href="<?php echo e(route('staff.appointment-record')); ?>">All</a>
                <a href="<?php echo e(route('staff.upcoming-appointment-record')); ?>" class="active">Upcoming</a>
                <a href="<?php echo e(route('staff.past-appointment-record')); ?>">Past</a>
...
<?php /**PATH C:\xampp\htdocs\amslaravel\resources\views/staff/upcoming-appointment-record.blade.php ENDPATH**/ ?>