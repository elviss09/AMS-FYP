...
<div class="calendar-container">
    <div class="calendar-header">
        <button id="prevMonth"><img src="<?php echo e(asset('img/arrow-icon.svg')); ?>" alt="prev"></button>
        <h2 id="monthYear"></h2>
        <button id="nextMonth"><img src="<?php echo e(asset('img/arrow-icon.svg')); ?>" alt="next"></button>
    </div>
...
<script>
    ...
    const appointmentDates = <?php echo json_encode($appointmentDates, 15, 512) ?>;
...
<?php /**PATH C:\xampp\htdocs\amslaravel\resources\views/staff/staff-calendar.blade.php ENDPATH**/ ?>