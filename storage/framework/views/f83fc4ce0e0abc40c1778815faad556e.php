    ...
    <div class="content">
        ...
        <div class="tab-page">
            <div class="tab-list">
                ...
                <a href="<?php echo e(route('staff.upcoming-appointment-record')); ?>">Upcoming</a>
                <a href="<?php echo e(route('staff.past-appointment-record')); ?>" class="active">Past</a>
...
<?php /**PATH C:\xampp\htdocs\amslaravel\resources\views/staff/past-appointment-record.blade.php ENDPATH**/ ?>