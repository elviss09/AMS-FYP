...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/nurse-slot-manage.css')); ?>">
</head>
<body>
        ...
        <div class="form-content">
            <div class="form-container">
                ...
                <div class="form-title-timezone">
                    ...
                    <div class="timezone">Time zone: Kuching, Sarawak (<?php echo e($timezone_display); ?>)</div>
                </div>
                ...
                <div class="day-list">
                    ...
                    <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="day-box" onclick="loadSlots('<?php echo e($day); ?>')">
            ...
            <div class="form-public-holiday">
                ...
                <form method="POST" action="<?php echo e(route('nurse.public-holiday.store')); ?>" class="holiday-form">
                    <?php echo csrf_field(); ?>
                    ...
                    <table class="holiday-table">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $holidays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $holiday): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e(\Carbon\Carbon::parse($holiday->holiday_date)->format('j M')); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($holiday->holiday_date)->format('D')); ?></td>
                                    <td><?php echo e($holiday->description); ?></td>
                                    <td class="remove-icon">
                                        <button onclick="deleteHoliday('<?php echo e($holiday->holiday_date); ?>')">
                                            <img src="<?php echo e(asset('img/close-grey.png')); ?>" alt="Delete">
                                        </button>
                                    </td>
                                </tr>
...
<script>
    ...
    const fetchSlotsURL = "<?php echo e(route('nurse.slot.fetch')); ?>";
    const addSlotURL = "<?php echo e(route('nurse.slot.add')); ?>";
    const deleteSlotURL = "<?php echo e(route('nurse.slot.delete')); ?>";
    ...
    function deleteHoliday(date) {
        if (confirm("Are you sure you want to remove this holiday?")) {
            fetch("<?php echo e(route('nurse.public-holiday.delete')); ?>", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "X-CSRF-TOKEN": "<?php echo e(csrf_token()); ?>"
...
<?php /**PATH C:\xampp\htdocs\amslaravel\resources\views/nurse/slot-manage.blade.php ENDPATH**/ ?>